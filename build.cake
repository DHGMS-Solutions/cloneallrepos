...
var isRepository = StringComparer.OrdinalIgnoreCase.Equals("DHGMS-Solutions/cloneallrepos", AppVeyor.Environment.Repository.Name);
...
var githubRepository = "cloneallrepos";
...
var sonarqubeProjectKey = "Dhgms.CloneAllRepos";
    ...
    .Does (() =>
{
    ...
    MSBuild("./src/Dhgms.CloneAllRepos.sln", new MSBuildSettings() {
            ToolPath = msBuildPath,
    ...
    build("./src/Dhgms.CloneAllRepos.sln");
});
...
Task("RunUnitTests")
    ...
    .Does(() =>
{
	var filePath = "./src/Dhgms.CloneAllRepos.UnitTests/Dhgms.CloneAllRepos.UnitTests.csproj";
